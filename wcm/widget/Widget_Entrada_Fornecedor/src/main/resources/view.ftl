...
<div id="sociallogin_${instanceId}" class="fluig-style-guide wcm-widget-class wcm_login wcm-widget-login super-widget" data-params="SocialLoginExample.instance()">

	<script type="text/template" class="master-widget-login-template">
