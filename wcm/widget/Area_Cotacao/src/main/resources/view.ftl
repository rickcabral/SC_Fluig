		...
		<div class="form-group">
			...
			<div class="panel col-md-12">
				...
				<div class="form-group col-md-2">
					...
					<button type="button" class="btn btn-primary form-control" id="Dados">Preencher Dados</button>
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-2">
					<label for="Dados">Ação</label>
					<button type="button" class="btn btn-default form-control" id="Dados">Ocultar</button>
				</div>
			</div>
